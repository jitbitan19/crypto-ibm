...
class RowsListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by RowsParser#rows.
    def enterRows(self, ctx:RowsParser.RowsContext):
        pass

    # Exit a parse tree produced by RowsParser#rows.
    def exitRows(self, ctx:RowsParser.RowsContext):
        pass
