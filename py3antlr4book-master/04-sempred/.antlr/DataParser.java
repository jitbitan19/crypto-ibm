// Generated from /Users/jitbitan/Documents/Cryptography/py3antlr4book-master/04-sempred/Data.g4 by ANTLR 4.13.1
...
public class DataParser extends Parser {
	...
	public static final int
		INT=1, WS=2;
	public static final int
		RULE_top = 0, RULE_group = 1, RULE_sequence = 2;
	...
	public static class SequenceContext extends ParserRuleContext {
		...
		public SequenceContext(ParserRuleContext parent, int invokingState,  n) {
			super(parent, invokingState);
			this.n = n;
		}
	...
	public final SequenceContext sequence( n) throws RecognitionException {
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(15);
					match(INT);
					((SequenceContext)_localctx).i = _localctx.i+1;
					}
					} 
				}
				setState(21);
